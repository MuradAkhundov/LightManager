package com.muradakhundov.lightmanager
...
import com.muradakhundov.lightmanager.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupAppName() {
        val spannableString = SpannableString(getString(R.string.light_manager))
        val colorSpan = ForegroundColorSpan(ContextCompat.getColor(this, R.color.green))
        spannableString.setSpan(colorSpan, 5, 12, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
